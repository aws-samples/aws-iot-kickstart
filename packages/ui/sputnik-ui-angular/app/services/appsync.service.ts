...
import { DEFAULT_NAMESPACE } from '@deathstar/sputnik-infra/stack/nested/device/management/constants'
// AWS
...
import { DeviceStats, SystemStats, SystemBlueprintStats } from '@deathstar/sputnik-ui-angular/app/models/stats.model'
// Queries
// import getAllDeviceTypes from '@deathstar/sputnik-ui-angular/app/graphql/queries/getAllDeviceTypes';
import getData from '@deathstar/sputnik-ui-angular/app/graphql/queries/data.get'
import getDevice from '@deathstar/sputnik-ui-angular/app/graphql/queries/device.get'
import getDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/queries/device-blueprint.get'
import getDeviceStats from '@deathstar/sputnik-ui-angular/app/graphql/queries/device.getStats'
import getDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/queries/device-type.get'
import getSetting from '@deathstar/sputnik-ui-angular/app/graphql/queries/setting.get'
import getSystem from '@deathstar/sputnik-ui-angular/app/graphql/queries/system.get'
import getSystemStats from '@deathstar/sputnik-ui-angular/app/graphql/queries/system.getStats'
import getSystemBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/queries/system-blueprint.get'
import getJustInTimeOnBoardingState from '@deathstar/sputnik-ui-angular/app/graphql/queries/just-in-time-on-boarding-state.get'
import getUser from '@deathstar/sputnik-ui-angular/app/graphql/queries/user.get'
import listDeployments from '@deathstar/sputnik-ui-angular/app/graphql/queries/deployments.list'
import listDevices from '@deathstar/sputnik-ui-angular/app/graphql/queries/devices.list'
import listDevicesOfDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/queries/devices-of-device-type.list'
import listDevicesWithDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/queries/devices-with-device-blueprint.list'
import listDeviceBlueprints from '@deathstar/sputnik-ui-angular/app/graphql/queries/device-blueprints.list'
import listDeviceTypes from '@deathstar/sputnik-ui-angular/app/graphql/queries/device-types.list'
import getIoTEvents from '@deathstar/sputnik-ui-angular/app/graphql/queries/iot-events.get'
import getLastIoTEvent from '@deathstar/sputnik-ui-angular/app/graphql/queries/iot-last-event.get'
import listGroups from '@deathstar/sputnik-ui-angular/app/graphql/queries/groups.list'
import listTenants from '@deathstar/sputnik-ui-angular/app/graphql/queries/tenants.list'
import listSystems from '@deathstar/sputnik-ui-angular/app/graphql/queries/systems.list'
import listUsers from '@deathstar/sputnik-ui-angular/app/graphql/queries/users.list'
import listSystemBlueprints from '@deathstar/sputnik-ui-angular/app/graphql/queries/system-blueprints.list'
import s3ListObjectsV2 from '@deathstar/sputnik-ui-angular/app/graphql/queries/s3.list-objects-v2'
// Mutations
import addDeployment from '@deathstar/sputnik-ui-angular/app/graphql/mutations/deployment.add'
import addDevice from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device.add'
import addDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device-blueprint.add'
import addDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device-type.add'
import addSystem from '@deathstar/sputnik-ui-angular/app/graphql/mutations/system.add'
import addSystemBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/mutations/system-blueprint.add'
import createCertificate from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device.create-certificate'
import deleteDevice from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device.delete'
import deleteDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device-blueprint.delete'
import deleteDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device-type.delete'
import deleteSystem from '@deathstar/sputnik-ui-angular/app/graphql/mutations/system.delete'
import deleteSystemBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/mutations/system-blueprint.delete'
import deleteUser from '@deathstar/sputnik-ui-angular/app/graphql/mutations/user.delete'
import disableUser from '@deathstar/sputnik-ui-angular/app/graphql/mutations/user.disable'
import enableUser from '@deathstar/sputnik-ui-angular/app/graphql/mutations/user.enable'
import inviteUser from '@deathstar/sputnik-ui-angular/app/graphql/mutations/user.invite'
import addTenant from '@deathstar/sputnik-ui-angular/app/graphql/mutations/tenant.add'
import refreshSystem from '@deathstar/sputnik-ui-angular/app/graphql/mutations/system.refresh'
import setJustInTimeOnBoardingState from '@deathstar/sputnik-ui-angular/app/graphql/mutations/just-in-time-on-boarding-state.set'
import updateDevice from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device.update'
import updateDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device-blueprint.update'
import updateDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/mutations/device-type.update'
import updateSetting from '@deathstar/sputnik-ui-angular/app/graphql/mutations/setting.update'
import updateSystem from '@deathstar/sputnik-ui-angular/app/graphql/mutations/system.update'
import updateSystemBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/mutations/system-blueprint.update'
import updateUser from '@deathstar/sputnik-ui-angular/app/graphql/mutations/user.update'
// Subscriptions
import addedDevice from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device.added'
import addedDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device-blueprint.added'
import addedDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device-type.added'
import addedSystem from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/system.added'
import addedSystemBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/system-blueprint.added'
import deletedDevice from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device.deleted'
import deletedDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device-blueprint.deleted'
import deletedDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device-type.deleted'
import deletedSystem from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/system.deleted'
import deletedSystemBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/system-blueprint.deleted'
import updatedDevice from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device.updated'
import updatedDeviceBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device-blueprint.updated'
import updatedDeviceType from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/device-type.updated'
import updatedSystem from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/system.updated'
import updatedSystemBlueprint from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/system-blueprint.updated'
import addedTenant from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/tenant.added'
import addedIoTEvent from '@deathstar/sputnik-ui-angular/app/graphql/subscriptions/iot-event.added'
import { Group } from '../models/group.model'
import { IoTEvent, IoTEvents } from '../models/iot-event.model'
...
export interface AddedTenant {
		onAddedTenant(result: string): void
}

export interface AddedIoTEvent {
...
export class AppSyncService {
	...
	public listTenants (): Promise<string[]> {
		return this.query(listTenants, {}).then(r => r.data.listTenants)
	}

	public addTenant (name: string): Group {
		return this.mutation(addTenant, { name }).then(r => r.data.addTenant)
	}

	public onAddedTenant (hook: AddedTenant) {
		this.subscribe(addedTenant, {}).subscribe({
			next: result => {
				return hook.onAddedTenant(result.value.data.addedTenant.tenant)
			},
		})
	}
	...
	private cleanIncomingDevice (device: Device) {
		...
		if (device && device.hasOwnProperty('metadata') && device.metadata) {
	...
	public addDevice (name: string, deviceTypeId = 'UNKNOWN', deviceBlueprintId = 'UNKNOWN') {
	...
	// Device IoT Events
	public getIoTEvents (namespace: string, deviceId: string): Promise<IoTEvent[]> {
		return this.query(getIoTEvents, { namespace, deviceId }).then(d => d.data.getEvents.events)
	}

	public getLastIoTEvent (namespace: string, deviceId: string): Promise<IoTEvent> {
		return this.query(getLastIoTEvent, { namespace, deviceId }).then(d => d.data.getLastEvent)
	}

	public onAddedIoTEvent (hook: AddedIoTEvent): void {
		this.subscribe(addedIoTEvent, {}).subscribe({
			next: result => {
				return hook.onAddedIoTEvent(result.value.data.addedEvent)
			},
		})
	}
