...
import getIoTEvents from '../graphql/queries/iot-events.get'
import getLastIoTEvent from '../graphql/queries/iot-last-event.get'
import listGroups from '../graphql/queries/groups.list'
import listTenants from '../graphql/queries/tenants.list'
...
import addSystemBlueprint from '../graphql/mutations/system-blueprint.add'
...
import addTenant from '../graphql/mutations/tenant.add'
import refreshSystem from '../graphql/mutations/system.refresh'
import setJustInTimeOnBoardingState from '../graphql/mutations/just-in-time-on-boarding-state.set'
...
import addedTenant from '../graphql/subscriptions/tenant.added'
import addedIoTEvent from '../graphql/subscriptions/iot-event.added'
