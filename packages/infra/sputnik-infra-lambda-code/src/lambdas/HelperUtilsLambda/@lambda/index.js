...
const UsageMetrics = require('@lambda/usage-metrics')
...
exports.handler = (event, context, callback) => {
	...
	if (event.RequestType === 'Delete' || event.RequestType === 'Update' || event.RequestType === 'Create') {
		...
		} else if ((event.RequestType === 'Create' || event.RequestType === 'Update') && event.ResourceProperties.customAction === 'createUUID') {
